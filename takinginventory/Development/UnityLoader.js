...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'ti.data';
    var REMOTE_PACKAGE_BASE = 'ti.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 36316948;
      var PACKAGE_UUID = 'c9822fca-fe04-4819-b858-a673c776c092';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 33204093, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(33204093, 33204114, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(33204114, 33216003, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(33216003, 35414351, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(35414351, 36289323, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(36289323, 36316948, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_ti.data');

    };
    Module['addRunDependency']('datafile_ti.data');
